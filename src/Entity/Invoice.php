...
class Invoice extends AbstractEntity
{
    ...
    public function __construct(
        ...
        #[ORM\Column(length: 120, nullable: true)]
        private ?string $customerGovernorate = null,
        #[ORM\Column(type: 'uuid', nullable: true)]
        private ?string $customerGovernorateId = null,
        #[ORM\Column(length: 120, nullable: true)]
        private ?string $customerLocality = null,
        #[ORM\Column(type: 'uuid', nullable: true)]
        private ?string $customerLocalityId = null,
        #[ORM\Column]
    ...
    public function setCustomerSnapshot(?string $name, ?string $email, ?string $phone, ?string $address, ?string $city, ?string $postalCode, ?string $country, ?string $countryId = null, ?string $governorate = null, ?string $governorateId = null, ?string $locality = null, ?string $localityId = null): void
    {
        ...
        $this->customerGovernorate = $governorate;
        $this->customerGovernorateId = $governorateId;
        $this->customerLocality = $locality;
        $this->customerLocalityId = $localityId;
        $this->touch();
    }
    ...
    public function getCustomerGovernorate(): ?string
    {
        return $this->customerGovernorate;
    }

    public function getCustomerGovernorateId(): ?string
    {
        return $this->customerGovernorateId;
    }

    public function getCustomerLocality(): ?string
    {
        return $this->customerLocality;
    }

    public function getCustomerLocalityId(): ?string
    {
        return $this->customerLocalityId;
    }
