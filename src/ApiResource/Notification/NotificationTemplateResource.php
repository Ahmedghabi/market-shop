...
#[ApiResource(
    ...
    operations: [
        ...
        new GetCollection(uriTemplate: '/boutiques/{boutiqueId}/notification-templates', security: "is_granted('ROLE_BOUTIQUE_ADMIN')", output: NotificationTemplateOutput::class, provider: NotificationTemplateProvider::class),
        new Post(uriTemplate: '/boutiques/{boutiqueId}/notification-templates', security: "is_granted('ROLE_BOUTIQUE_ADMIN')", input: NotificationTemplateInput::class, output: NotificationTemplateOutput::class, processor: NotificationTemplateProcessor::class),
