...
#[ApiResource(
    ...
    operations: [
        ...
        new Post(name: 'favorite_shop_add', uriTemplate: '/favorites/shops/{shopId}', security: "is_granted('PUBLIC_ACCESS')", input: false, output: ShopFavoriteOutput::class, processor: FavoriteProcessor::class),
        new Delete(name: 'favorite_shop_delete', uriTemplate: '/favorites/shops/{shopId}', security: "is_granted('PUBLIC_ACCESS')", input: false, read: false, processor: FavoriteProcessor::class),
    ],
)]
