...
#[ApiResource(
    ...
    operations: [
        new GetCollection(
            uriTemplate: '/boutiques/{boutiqueId}/subscription-requests',
            uriVariables: BOUTIQUE_REQUEST_URI_VARIABLES,
        ...
        new Get(
            uriTemplate: '/boutiques/{boutiqueId}/subscription-requests/{id}',
            uriVariables: BOUTIQUE_REQUEST_URI_VARIABLES + ['id' => new Link(schema: ['type' => 'string', 'format' => 'uuid'], property: 'id')],
            security: "is_granted('ROLE_BOUTIQUE_ADMIN')",
            output: SubscriptionRequestOutput::class,
            provider: SubscriptionRequestProvider::class,
        ),
