...
#[ApiResource(
    shortName: 'Invoice',
    operations: [
        new GetCollection(uriTemplate: '/boutiques/{boutiqueId}/invoices', security: "is_granted('ROLE_BOUTIQUE_ADMIN')", output: InvoiceOutput::class, provider: InvoiceProvider::class),
        new Get(uriTemplate: '/boutiques/{boutiqueId}/invoices/{id}', security: "is_granted('ROLE_BOUTIQUE_ADMIN')", output: InvoiceOutput::class, provider: InvoiceProvider::class),
        new Post(name: 'generate_order_invoice', uriTemplate: '/boutiques/{boutiqueId}/orders/{orderId}/invoice', security: "is_granted('ROLE_BOUTIQUE_ADMIN')", input: false, output: InvoiceOutput::class, processor: InvoiceProcessor::class),
