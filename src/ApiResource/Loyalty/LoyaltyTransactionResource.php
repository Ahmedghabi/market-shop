...
#[ApiResource(
    ...
    operations: [
        new GetCollection(uriTemplate: '/loyalty/accounts/{accountId}/transactions', security: "is_granted('ROLE_CUSTOMER')"),
        new Post(uriTemplate: '/loyalty/accounts/{accountId}/transactions', security: "is_granted('ROLE_CAISSIER')"),
    ],
