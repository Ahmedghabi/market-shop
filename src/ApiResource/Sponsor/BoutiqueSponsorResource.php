...
#[ApiResource(
    ...
    operations: [
        new GetCollection(uriTemplate: '/boutiques/{boutiqueId}/sponsors'),
        new Post(uriTemplate: '/boutiques/{boutiqueId}/sponsors', security: "is_granted('ROLE_BOUTIQUE_ADMIN')"),
        new Delete(uriTemplate: '/boutiques/{boutiqueId}/sponsors/{id}', security: "is_granted('ROLE_BOUTIQUE_ADMIN')"),
    ],
