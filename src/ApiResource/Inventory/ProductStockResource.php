...
#[ApiResource(
    ...
    operations: [
        new Get(uriTemplate: '/boutiques/{boutiqueId}/products/{productId}/stock', security: "is_granted('ROLE_CAISSIER')"),
        new Patch(uriTemplate: '/boutiques/{boutiqueId}/products/{productId}/stock', security: "is_granted('ROLE_BOUTIQUE_ADMIN')"),
    ],
