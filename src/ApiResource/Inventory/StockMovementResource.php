...
#[ApiResource(
    ...
    operations: [
        new GetCollection(uriTemplate: '/boutiques/{boutiqueId}/stock-movements', security: "is_granted('ROLE_CAISSIER')"),
        new Post(uriTemplate: '/boutiques/{boutiqueId}/stock-movements', security: "is_granted('ROLE_BOUTIQUE_ADMIN')"),
    ],
