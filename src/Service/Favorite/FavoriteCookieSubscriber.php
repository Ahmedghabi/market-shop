...
final class FavoriteCookieSubscriber implements EventSubscriberInterface
{
    public const COOKIE_NAME_ATTRIBUTE = '_market_shop_favorites_cookie_name';
    public const COOKIE_VALUE_ATTRIBUTE = '_market_shop_favorites_cookie_value';
    public const COOKIE_CLEAR_ATTRIBUTE = '_market_shop_favorites_cookie_clear';
