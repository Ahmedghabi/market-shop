...
final readonly class InvoiceService
{
    ...
    public function generateForOrder(string $boutiqueId, string $orderId): Invoice
    {
        ...
        $invoice->setCustomerSnapshot($order->getCustomerName(), $order->getCustomerEmail(), $order->getCustomerPhone(), $order->getShippingAddress(), $order->getShippingCity(), null, null);
