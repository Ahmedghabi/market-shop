...
export function ReviewSection({ boutiqueSlug, productSlug }: ReviewSectionProps) {
  ...
  const endpoint = productSlug
    ? `/api/boutiques/${boutiqueSlug}/products/${productSlug}/reviews`
    : `/api/boutiques/${boutiqueSlug}/reviews`;
